...
namespace NI {
	Object::Object() {
#if defined(SE_NI_OBJECT_FNADDR_CTOR) && SE_NI_OBJECT_FNADDR_CTOR > 0
		const auto NI_Object_ctor = reinterpret_cast<Object * (__thiscall*)(Object*)>(SE_NI_OBJECT_FNADDR_CTOR);
		NI_Object_ctor(this);
#else
	...
	Object::~Object() {
#if defined(SE_NI_OBJECT_FNADDR_DTOR) && SE_NI_OBJECT_FNADDR_DTOR > 0
		const auto NI_Object_dtor = reinterpret_cast<Object * (__thiscall*)(Object*)>(SE_NI_OBJECT_FNADDR_DTOR);
		NI_Object_dtor(this);
#else
		throw not_implemented_exception();
#endif
