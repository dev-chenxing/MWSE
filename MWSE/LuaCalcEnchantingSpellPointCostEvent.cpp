...
namespace mwse::lua::event {
	CalculateEnchantingSpellPointCostEvent::CalculateEnchantingSpellPointCostEvent(TES3::MobileActor* serviceActor, float spellPointCost) :
		ObjectFilteredEvent("calcEnchantingSpellPointCost", serviceActor ? serviceActor->reference : nullptr),
	...
	sol::table CalculateEnchantingSpellPointCostEvent::createEventTable() {
