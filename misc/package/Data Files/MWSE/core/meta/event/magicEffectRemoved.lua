...
--- @field effectInstance tes3magicEffectInstance *Read-only*. The unique instance of the magic effect that caused the source effect to be removed.
...
--- @field target tes3reference *Read-only*. The target of the magic effect instance that caused the source effect to be removed.
